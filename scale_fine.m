...
N1= boxfilter(tem, r1);
p=6;
[WD, Cmax,i_mean,S_map,i_mean2]= weight_spd_fine(imgSeqColor,p,r1,lambda);
...
for i = 1:n
    ...
    w1 = 0.5+(S_map(:,:,1)-S_map(:,:,2))/2;
    Dr= w1.*F_temp2_detail(:,:,1) ;
    Dv =  (1-w1).*F_temp2_detail(:,:,2);
    D1 = Dr+Dv;
    D1 = ATEE(D1,imgSeqColor);
end
